...
void Level1::Initialize() {
	...
	state.map = new Map(LEVEL1_WIDTH, LEVEL1_HEIGHT, level1_data, mapTextureID, 1.0f, 9, 9);
	...
	state.enemies[0].position = glm::vec3(3, -2.3, 0);
	state.enemies[0].aiType = WALKERAROUND;
	state.enemies[0].aiState = IDLE;
	state.enemies[1].position = glm::vec3(10, -4, 0);
	state.enemies[1].aiType = WALKERAROUND;
	state.enemies[1].aiState = IDLE;
	state.enemies[2].position = glm::vec3(11, -5, 0);
